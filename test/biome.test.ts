...
const LINT = fileURLToPath(new URL('./captured/biome-lint-2.5.12.txt', import.meta.url))
const FORMAT = fileURLToPath(new URL('./captured/biome-format-2.5.12.txt', import.meta.url))
