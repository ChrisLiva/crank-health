 ...
 */
const LINT = fileURLToPath(new URL('./captured/ruff-lint-0.16.6.json', import.meta.url))
const FORMAT = fileURLToPath(new URL('./captured/ruff-format-0.16.6.json', import.meta.url))
