 ...
 */
const FALLOW = fileURLToPath(new URL('./captured/fallow-dead-code-3.20.0.json', import.meta.url))
const KNIP = fileURLToPath(new URL('./captured/knip-6.32.3.json', import.meta.url))
